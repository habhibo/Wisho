...
class inmultigametest extends StatefulWidget {
AudioPlayer audioPlayer;
AudioCache audioCache;
var nameTab = [];
var charTab = [];
inmultigametest(this.nameTab,this.charTab);

@override
_inmultigametestState createState() => _inmultigametestState();
}
...
class _inmultigametestState extends State<inmultigametest> with TickerProviderStateMixin,WidgetsBindingObserver{
...
builder: (context) => gameended(audioPlayer,audioCache,charTab,pointsTabSp,resultTab)));*/
...
if(myEmoji!="-1"){
setState(() {
emoji[widget.nameTab.indexOf(myEmoji.substring(1))]="emo"+myEmoji.substring(0,1);
});
...
pointsTab.add(value.docs[index].data()["points"]);
statutTab.add(value.docs[index].data()["statut"]);
...
setState((){
if (value != null) {
statutTab.add(value.docs[0].data()["statut"]);
pointsTab.add(value.docs[0].data()["points"]);
...
pointsTab=pointsTabSp;
pointsTabSp.sort();

resultTab[0]=widget.nameTab[pointsTab.indexOf(pointsTabSp[0])];
resultTab[1]=widget.nameTab[pointsTab.indexOf(pointsTabSp[1])];
resultTab[2]=widget.nameTab[pointsTab.indexOf(pointsTabSp[2])];
resultTab[3]=widget.nameTab[pointsTab.indexOf(pointsTabSp[3])];

charTab[0]=widget.nameTab[pointsTab.indexOf(pointsTabSp[0])];
charTab[1]=widget.nameTab[pointsTab.indexOf(pointsTabSp[1])];
charTab[2]=widget.nameTab[pointsTab.indexOf(pointsTabSp[2])];
charTab[3]=widget.nameTab[pointsTab.indexOf(pointsTabSp[3])];
...
name1=widget.nameTab[0];
name2=widget.nameTab[1];
name3=widget.nameTab[2];
name4=widget.nameTab[3];

char1=widget.charTab[0];
char2=widget.charTab[1];
char3=widget.charTab[2];
char4=widget.charTab[3];
...
color :Color.fromRGBO(255, 255, 255, double.parse(blendColorTab[0])),
...
Container(child:Text(name1,style: TextStyle(color: Colors.white,fontSize:10,fontWeight: FontWeight.w800),)),
...
Container(child : Text(point1,style: TextStyle(fontSize: 20,fontWeight: FontWeight.w700)))]),SizedBox(width:10,
),
Column(mainAxisAlignment:MainAxisAlignment.center,
children: [Container(child:Stack(alignment:Alignment.topLeft
,children: [Stack(alignment:Alignment.bottomCenter,children: [
...
color :Color.fromRGBO(255, 255, 255, double.parse(blendColorTab[1])),
colorBlendMode: BlendMode.modulate,
width: 65,
height: 65,
),
...
children:[ SizedBox(height:00),Center(
child: Container(padding: EdgeInsets.all(1),width:50,height:20,decoration: BoxDecoration(borderRadius: BorderRadius.only(bottomLeft: Radius.circular(15),bottomRight: Radius.circular(15),topLeft: Radius.circular(15),topRight:Radius.circular(15) ),color: Colors.black),child:
Container(child:Text(name2,style: TextStyle(color: Colors.white,fontSize:10,fontWeight: FontWeight.w800),)),
...
Container(child : Text(point2,style: TextStyle(fontSize: 20,fontWeight: FontWeight.w700)))]),
SizedBox(width:10,
),
Column(mainAxisAlignment:MainAxisAlignment.center,
children: [Container(child:Stack(alignment:Alignment.topLeft
...
color :Color.fromRGBO(255, 255, 255, double.parse(blendColorTab[2])),
colorBlendMode: BlendMode.modulate,
width: 65,
height: 65,
),
...
children:[ SizedBox(height:00),Center(
child: Container(padding: EdgeInsets.all(1),width:50,height:20,decoration: BoxDecoration(borderRadius: BorderRadius.only(bottomLeft: Radius.circular(15),bottomRight: Radius.circular(15),topLeft: Radius.circular(15),topRight:Radius.circular(15) ),color: Colors.black),child:
Container(child:Text(name3,style: TextStyle(color: Colors.white,fontSize:10,fontWeight: FontWeight.w800),)),
...
Container(child : Text(point3,style: TextStyle(fontSize: 20,fontWeight: FontWeight.w700)))]),SizedBox(width:10,
),
Column(mainAxisAlignment:MainAxisAlignment.center,
children: [Container(child:Stack(alignment:Alignment.topLeft
,children: [Stack(alignment:Alignment.bottomCenter,children: [
...
color :Color.fromRGBO(255, 255, 255, double.parse(blendColorTab[3])),
colorBlendMode: BlendMode.modulate,
width: 65,
height: 65,
),
...
children:[ SizedBox(height:00),Center(
child: Container(padding: EdgeInsets.all(1),width:50,height:20,decoration: BoxDecoration(borderRadius: BorderRadius.only(bottomLeft: Radius.circular(15),bottomRight: Radius.circular(15),topLeft: Radius.circular(15),topRight:Radius.circular(15) ),color: Colors.black),child:
Container(child:Text(name4,style: TextStyle(color: Colors.white,fontSize:10,fontWeight: FontWeight.w800),)),
...
Container(child : Text(point4,style: TextStyle(fontSize: 20,fontWeight: FontWeight.w700)))]),
],),
